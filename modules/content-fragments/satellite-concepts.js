...
(function() {
  ...
  const events = [
    { id: `evt-1623-misselden-circle-commerce`, year: 1623, country: `İngiltere`, title: `Misselden - Circle of Commerce`, summary: { intro: `Misselden'in Malynes ile tartışmasının ikinci eseri; ticaret dengesi teorisinin erken sistemli formülasyonu.` }, conceptRefs: [`edward-misselden`] },
    { id: `evt-1667-colbert-tariff`, year: 1667, country: `Fransa`, title: `Colbert 1667 Tarife`, summary: { intro: `Colbert'in ikinci büyük tarife paketi; Hollanda ve İngiliz mallarına ek vergi.` }, conceptRefs: [`jean-baptiste-colbert`, `protectionism`] },
    { id: `evt-1698-davenant-publick-revenues`, year: 1698, country: `İngiltere`, title: `Davenant - Discourses on the Publick Revenues`, summary: { intro: `Devlet gelirleri + ticaret istatistiği üzerine analiz; Petty'nin politik aritmetik geleneğinin devamı.` }, conceptRefs: [`charles-davenant`] }
  ];
