## 2.1 Fizyokrasi öncesi: iki figür, iki kanal

Quesnay 1758'de *Tableau économique*'i bastırdığında, fizyokrasi sıfırdan doğmadı. Arkasında en az iki on yıllık bir mayalanma vardı: Paris salonlarında dolaşan ama henüz okul kıvamına gelmemiş bir kavramlar yığını — *circulation*, *produit net*, *ordre naturel*, *laissez-faire* — ve bu kavramları farklı dozlarda kullanan iki öncü figür. Birincisi, Quesnay'in masasında neredeyse her zaman duran bir kitabın yazarıdır: Richard Cantillon (~1680-1734). İkincisi geriye kitap değil, *çevre* bırakmıştır: Vincent de Gournay (1712-1759).

İki figür çok farklıdır. Cantillon İrlanda kökenli bir Fransız bankerdir; serveti John Law'un *Système*'i (1716-20) çöktüğünde spekülasyondan kazanılmış, fikirleri kozmopolit bir okuma birikiminden — Petty, Locke, Davenant — süzülmüştür. Eseri tek ve ölümünden sonra yayımlanan kısa bir kitaptır^[1]. Gournay ise tüccar, sonra *intendant du commerce*'tir; tam bir kitap yerine bir tercüme ve eleştiri atölyesi kurar. Cantillon teoriyi getirir, Gournay habitusu örer. Quesnay her ikisini de devralıp radikalleştirecektir.

Bu bölüm iki figürün fizyokrasiye verdiği şeyi inceler. Önce Cantillon'un *Essai*'sini üç eksende okuruz: girişimci, içsel değer, parasal sirkülasyon. Sonra Gournay çevresinin yaptığını — kimleri tercüme ettiklerini, hangi sloganı popülerleştirdiklerini — ele alırız. Üçüncüsü, Cantillon-Gournay çiftinin Quesnay'in 1758 sentezini nasıl mümkün kıldığını gösteririz. Sonunda, *laissez-faire, laissez-passer* sloganının tarihsel atfındaki karanlık noktaları tartışırız: o ifade kime aittir, hangi koşulda söylenmiştir, neden önemlidir.

## 2.2 Cantillon'un *Essai*'si: yazılışı, yayımı, mirası

Richard Cantillon'un *Essai sur la Nature du Commerce en Général*'inin yayım tarihi 1755'tir. Yazıldığı tarih daha karanlıktır: büyük olasılıkla 1720'lerin sonu ile 1730'ların başı arasında, John Law balonunun çöküşünün ardından — Cantillon o balonu önceden okuyup vaktinde satarak servet edinmişti. Metin önce el yazması olarak Paris'te dolaştı, sonra muhtemelen Mirabeau'nun (Bölüm 7'de işleyeceğimiz fizyokratın babası) eline geçti; uzun süre kayıp sayıldı. Sonunda Fransızca olarak ortaya çıktığında — yazardan yaklaşık 20 yıl sonra — yazarı tartışmalıydı; bazı bibliyografyalar uzun süre kitabı "anonim" olarak kayda geçirdi^[2].

Bu gecikmenin paradoksu önemlidir. *Essai*, 1755'te basıldığında, **gerçek tarihsel anı**nı çoktan kaçırmıştı: Law'un 1720 çöküşüne canlı bir yanıt olarak yazılmış metin, otuz beş yıl sonra çıktığında geçmişin bir okuması haline gelmişti. Ama tam da bu nedenle **fizyokratların eline** zamanında geçti. 1755'te Quesnay 61 yaşındaydı, Versailles'da Madame de Pompadour'un hekimiydi ve iktisat denemelerini henüz yazmaya başlamıştı (ilk *Encyclopédie* maddeleri "Fermiers" 1756, "Grains" 1757). Cantillon'un kitabı Quesnay'in masasına tam kendi sistemini biçimlendirmeye başladığı anda geldi.

Schumpeter'in *History of Economic Analysis* (1954)'ında verdiği değerlendirme bu gecikmeyi açıklar. Schumpeter'e göre Cantillon "*the first systematic treatise on economics*" yazmıştı — Petty'nin parçalı denemelerinden ve Locke'un para üzerine yazılarından farklı olarak, *Essai* bir bütün halinde kuramsal bir mimari sunar^[3]. Schumpeter bu nedenle Cantillon'u "Smith'ten önce iktisadın gerçek kurucusu" olarak tanımlar — abartılı ama anlamlı bir nitelendirme.

*Essai*'nin yapısı üç bölümlüdür. Birinci bölüm "servet, toprak, emek" üzerine; üretimin reel temellerini ele alır. İkinci bölüm "para, faiz, dolaşım" üzerine; modern para teorisinin habercisi olan tezleri içerir. Üçüncü bölüm "uluslararası ticaret, kambiyo, bankacılık" üzerine; uygulamalı kısımdır. Bu sıra rastgele değildir: önce reel temel, sonra parasal süperstrüktür, en sonra dış ticaret. Aynı yapısal sıra, Quesnay'in 1758 *Tableau*'sunda da görülecektir.

## 2.3 *Entrepreneur* — risk taşıyıcı, artık-kazanan

Cantillon'un en özgün kuramsal katkılarından biri *entrepreneur* kavramıdır. 18. yüzyıl başında bu kelime Fransızcada vardı, ama daha çok "müteahhit", "bir işi üstlenen" anlamına geliyordu. Cantillon ona bir iktisadi **işlev** yükledi: girişimci, *belirsizlik altında* karar veren ve kazancı *kalıntı* (residual) olarak alan kişidir.
...
Cantillon'un bu çerçevesinin merkantilizmle ilişkisi de ilginçtir. Mun (Bölüm 4, *merkantilizm*) için servet altın-gümüş stokuydu; Cantillon için servet *topraktan elde edilen ürün* + *o ürünü dönüştüren emek*tir. Para, Cantillon'da bir ölçü ve dolaşım aracıdır; servet değildir. Bu, Hume'un 1752'deki argümanından (Bölüm 9, *merkantilizm*) yaklaşık çeyrek yüzyıl önce yapılmış bir hamledir — ama gecikmeli yayım nedeniyle Cantillon'un önceliği iktisat tarihinde yeterince tanınmamıştır.

## 2.5 Dolaşım ve Cantillon etkisi

*Essai*'nin İkinci Bölümü para teorisidir. Cantillon burada hem Locke'un (*Some Considerations of the Consequences of the Lowering of Interest*, 1691) hem de John Law'un (*Money and Trade Considered*, 1705) tezlerine karşı incelikli bir konum geliştirir. Locke'un miktar teorisi — para arzının fiyatları orantılı olarak belirlediği tezi — Cantillon'da nüanslandırılır: para arzındaki artış fiyatları yükseltir, ama yükseliş **eşit dağılmaz**.
...
**Eksen 1: Servetin reel kaynağı topraktır.** Bu, fizyokrasinin merkez tezidir. Cantillon onu kuramsal olarak kurmuş, Quesnay radikalleştirmiştir. Quesnay'in sanayi-steril tezi (Bölüm 5, *Tableau*) Cantillon'da olmayan bir uçtur — ama temel "toprak = servetin kaynağı" tezini Cantillon'dan alır.

**Eksen 2: Ekonomi bir dolaşım sistemidir.** Cantillon'un *Essai*'sinin alt çerçevesi şudur: para sınıflar arasında dolaşır — toprak sahipleri kira alır, harcar; çiftçiler ürün üretir, satar; tüccarlar dolaşımı yönetir, kâr alır. Bu dairevi yapının açık bir matematiksel diyagrama dökülmesi Cantillon'da yoktur — onu **Quesnay yapacaktır** *Tableau*'da. Ama dairevi mantığın kendisi Cantillon'da kurulur.

**Eksen 3: Girişimci özel bir aktördür; devlet değil.** Bu, fizyokrasinin *laissez-faire* eğiliminin altyapısıdır. Cantillon'un kuramsal çerçevesinde devletin rolü vergi alıcı, çerçeve koruyucudur — üretici değil. Quesnay'in *Maximes générales*'inde (1767) devletin tarımsal sektörü en azından **engellememesi** gerektiği vurgusu, Cantillon'un bu önceki konumlandırmasının doğrudan ardılıdır.
...
## 2.8 Vincent de Gournay — pratik bir bridge figür
...
**Versiyon 3: 18. yüzyılın geniş entelektüel havası.** Bazı tarihçiler (Jacob Viner, *Studies in the Theory of International Trade*, 1937) sloganın tek bir kişiye atfedilmesinin yanıltıcı olduğunu öne sürer^[13]. *Laissez-faire* mantığı Boisguilbert (1646-1714), Cantillon ve çeşitli Fransız tüccar yazarlar arasında 17. yüzyıl sonundan itibaren dolaşıyordu; sonraki sloganlaştırma — özellikle Turgot'nun Gournay'i anma yazısı — bu havanın bir kişide **kristallenmesidir**, kişinin orijinal icadı değil.

Hangisi doğrudur? Tarihsel olarak en savunulabilir yargı şudur: Gournay'in bu ifadeyi **kullandığı** muhtemeldir (Turgot doğrudan tanıktır), ama **icat ettiği** kesin değildir. Daha doğru formülasyon: Gournay dolaşan bir mottoyu kurumsallaştırdı; Turgot'nun ölüm yazısı onu kanonlaştırdı; slogan 19. yüzyıl boyunca fizyokrasi-Smithçi liberalizm geleneğinin parolası oldu.

Bu belirsizliğin önemi şudur: iktisadi düşüncede bazı sloganlar — Bodin'in 1568'deki para-fiyat sezgisi, Hume'un 1752 fiyat-specie akışı, Smith'in 1776 "görünmez el"i — birer **kavşak figür** işlevi görür. Tek yazara atfedildiklerinde tarih basitleşir, ama gerçek köken çok-yazarlıdır. *Laissez-faire* sloganı da böyle bir kavşak figürdür: Gournay'e atıf sosyolojik olarak doğrudur (mottonun kurumsal taşıyıcısıdır), kavramsal olarak ise tek-yazarlı değildir.

## 2.10 Cantillon mı, Gournay mi? — Fizyokrasinin iki ayağı

Sonuç olarak: fizyokrasi tek bir kişinin (Quesnay) icadı değildir; en az iki önceki kanaldan beslenir.

Cantillon **kuramsal ayak**tır: girişimci kavramı, içsel değerin toprak-temelliliği, dolaşım sezgisi, Cantillon etkisi. Bu kavramlar, Quesnay'in *Tableau* matematiğine ve *produit net* tezine teorik içerik sağlar. Quesnay olmadan da Cantillon'un *Essai*'si önemli bir iktisat klasiği olurdu — ama tarihsel etkisi, Quesnay'in onu radikalleştirmesi sayesinde fizyokrasi okulunun resmi bir parçası haline geldi.

Gournay **kurumsal ayak**tır: salon, çeviri programı, kadro yetiştirme, sloganın kurumsallaştırılması. Bu olmadan da fizyokrasi bir okul olarak doğamazdı; teori yeterli değildi, onun bir **sosyal taşıyıcı**ya — Mirabeau'nun çevresi, Turgot'nun bürokratik konumu, Dupont'un editörlüğü — ihtiyacı vardı. Gournay bu sosyal yapının habitus altyapısını sağladı.

İki figür arasındaki tansiyona da dikkat etmek gerek. Cantillon nihayetinde tüm değeri toprağa indirgeyen bir kuram geliştirir; Gournay ise pratikte **manufaktürü ve ticareti** tarımla eşit önemde gören bir konumdadır. Quesnay (Bölüm 4-5) bu tansiyonun **Cantillon tarafı**na yerleşecektir: tarım üretkendir, sanayi sterildir. Turgot (Bölüm 8) ise daha çok **Gournay tarafı**nda kalacaktır: tarım önemlidir ama sanayi ve ticaret de servet üretir. Bu iç gerilim, fizyokrasinin 1760'lar boyunca Smith'in (Bölüm 9) eleştirisinde kullanacağı bir açık olacaktır — Smith fizyokrasinin tarımsal monomanisini reddedip, daha çok Gournay-tipi bir liberalizmi savunacaktır.
