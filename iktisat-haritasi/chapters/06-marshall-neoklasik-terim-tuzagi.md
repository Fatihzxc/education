## 6.1 Makasın iki ağzı: Marshall'ın sentezi

Marjinalist devrim güçlü ama tek-yanlıydı. Değeri tümüyle tüketici tarafına, marjinal faydaya yıkmıştı — ve bu, klasiklerin haklı olduğu bir şeyi gözden kaçırma riski taşıyordu: üretim maliyeti de fiyatı etkiler. Bir malı yapmak gerçekten bir şeye mal olur; arz tarafı yok sayılamaz.

Alfred Marshall'ın 1890'daki *Principles of Economics*'i tam bu birleştirmeyi yapar.^[1] Marshall'ın ünlü mecazı şudur: bir kâğıdı kesen makasın hangi ağzının kestiğini sormak anlamsızdır — ikisi birlikte keser. Fiyatı belirleyen de **arz** (klasik miras: üretim maliyeti) ile **talep** (marjinalist miras: marjinal fayda) makasının ortak hareketidir. Ne klasiklerin "değer maliyettir" tezi tek başına doğrudur, ne marjinalistlerin "değer faydadır" tezi; ikisi arz-talep dengesinde buluşur.
...
**"Neoklasik iktisat"** (yukarıda): Marshall'ın 1890'daki arz-talep sentezi ve onu izleyen mikroiktisat geleneği. Klasiğin maliyet tarafını marjinalizmin fayda tarafıyla birleştiren çerçeve.

**"Neoklasik sentez"** (bambaşka şey): İkinci Dünya Savaşı sonrası, özellikle Paul Samuelson'ın elinde olgunlaşan birleşim. Burada birleştirilen *Marshall ile marjinalizm* değil; **Keynes'in makroekonomisi ile neoklasik mikroekonomi**dir.^[2] Tez şuydu: kısa dönemde Keynesçi araçlar geçerli (devlet talebi yönetir, durgunluğu giderir), ama tam istihdama ulaşıldığında ekonomi yine neoklasik denge kurallarına döner. Yani makro Keynesçi, mikro neoklasik — ikisi tek ders kitabında (Samuelson'ın *Economics*'i, 1948) yan yana.

İkisini karıştırmak ciddi bir kafa karışıklığı yaratır: biri 1890'da değer kuramını birleştirir (mikro), öteki 1950'lerde Keynes ile dengeyi birleştirir (makro). Aralarında yarım yüzyıl ve bambaşka bir mesele var. Haritada Marshall kutusu "neoklasik iktisat"tır; "neoklasik sentez" ise Bölüm 7'deki Keynes'ten *sonra* gelen bir uzlaşmadır. Bu ayrımı baştan netleştirmek, ilerideki çok kafa karışıklığını önler.

## 6.3 Çıkar/kurum katmanı: dengenin depolitizasyonu

Neoklasik sentezin (Marshall anlamında) analitik gücü tartışmasız: arz-talep makası bugün hâlâ iktisadın en çok kullanılan aletidir. Ama iki-katman merceği burada da işler — bu kez "sınıf çıkarı"ndan çok bir *söylemsel işlev* biçiminde.

Klasik-Marx ailesinde iktisat açıkça *politik* iktisattı: değer, dağılım ve sınıf aynı çerçevede konuşuluyordu. Marshall'la birlikte disiplinin adı "politik iktisat"tan giderek sadece "iktisat" (*economics*) olur — ve odak, sınıflar arası dağılım kavgasından, bireysel ajanların denge etrafındaki optimizasyonuna kayar. Üretim faktörleri (emek, sermaye, toprak) artık sınıflar değil, her biri marjinal verimliliği kadar ödüllendirilen *girdiler*dir. Bölüşüm kavgası, teknik bir kaynak-tahsisi problemine dönüşür.
...
## 6.5 Bugün: ders kitabının grameri

Neoklasik iktisat bugün "bir ekol" değil, iktisadın *grameri*dir. Arz-talep diyagramı, denge fiyatı, esneklik, marjinal analiz, refah üçgenleri — her giriş dersinin ilk haftaları. Mankiw'in ya da Samuelson-Nordhaus'un ders kitabı, dünyanın her yerinde aynı marshallcı makasla açılır. Görünmezliği zaferinin tamlığındandır (marjinalizmde olduğu gibi).

Ama "neoklasik sentez" — Keynesçi makro + neoklasik mikro uzlaşması — çok daha kırılgan çıktı. 1970'lerin stagflasyonu o uzlaşmayı sarstı (Bölüm 7); makro alanı o günden beri bölünmüş durumda. Yani Marshall'ın *mikro* sentezi (1890) ders kitabının sağlam çekirdeği olarak kaldı; Samuelson'ın *makro* sentezi (1950'ler) ise tartışmalı ve sürekli yeniden müzakere edilen bir bölge oldu. İki "neoklasik"in kaderi bile farklı — terimleri ayırmanın neden önemli olduğunun son bir kanıtı.

Sonraki bölüm, tam o makro sahneye geçer: Büyük Buhran'ın neoklasik dengeyi nasıl çökerttiğini, Keynes'in cevabını, ve monetarizmin karşı-devrimini.
