Marjinalizmin ekonomi kartı şu sorudan başlar: **Bir malın fiyatı neden o seviyededir?**

Bu soru basit görünür, ama arkasında çok büyük bir düşünme değişimi vardır. Klasik iktisat çoğu zaman maliyete, emeğe ve üretim koşullarına bakmıştı. Marjinalistler ise "bunlar önemli, ama fiyatı anlamak için tüketicinin son birime verdiği değeri de görmeliyiz" dedi.

En temelden gidelim. Bir şeyi istiyorsun, ama paran, zamanın ve dikkatinin sınırı var. Bu yüzden her seçim aynı zamanda bir vazgeçiştir. Bir kitabı aldığında başka bir kitabı almaktan vazgeçersin. Bir tarlaya daha fazla emek verdiğinde o emeği başka bir işte kullanmaktan vazgeçersin. İşte iktisadın içindeki "maliyet" fikri burada yalnızca harcanan para değil, kaçırılan alternatif haline gelir.

Marjinalizm bunu küçük bir karar diliyle anlatır: Bir birim daha almak bana ne kazandırır? Bir birim daha üretmek bana neye mal olur? Bu iki soru karşılaşınca fiyat ve miktar fikri doğar.

## Marjinal fayda ne demektir?

Marjinal fayda, bir maldan **bir birim daha** tükettiğinde elde ettiğin ek yarardır.

Toplam fayda başka şeydir. Marjinal fayda başka şeydir. Toplam fayda, bütün tüketimin toplam etkisidir. Marjinal fayda ise son ek birimin etkisidir. Bu ayrım çok önemlidir, çünkü insanlar çoğu zaman toplam varlığa değil, ek birime göre karar verir.

Temsili bir örnek:

| Dilim ekmek | Toplam doyma | Son dilimin ek faydası |
|---:|---:|---:|
| 1 | 50 | 50 |
| 2 | 85 | 35 |
| 3 | 105 | 20 |
...
Bu tablo "ekmek önemsizdir" demiyor. Tam tersine, ekmeğin ilk dilimleri çok değerlidir. Ama belirli bir noktadan sonra son dilimin katkısı düşer. Buna azalan marjinal fayda diyebiliriz.
...
```text
talep tarafı: "son birim bana ne kadar fayda sağlıyor?"
          ↓
       fiyat
          ↑
arz tarafı: "son birimi üretmek neye mal oluyor?"
```
...
Basit bir temsili tablo düşünelim:

| Fiyat | Alıcıların istediği miktar | Satıcıların sunmak istediği miktar | Durum |
|---:|---:|---:|---|
| 10 | 100 | 30 | Talep fazlası |
| 20 | 75 | 55 | Talep hâlâ yüksek |
| 30 | 50 | 50 | Yaklaşık denge |
| 40 | 30 | 70 | Arz fazlası |

Bu tablo bize şunu gösterir: Fiyat sadece bir etiket değildir; davranışı düzenleyen bir sinyaldir. Fiyat düşükse çok kişi almak ister, ama üretici daha az sunabilir. Fiyat yüksekse üretici daha çok sunmak ister, ama alıcı azalabilir. Denge fikri bu karşılıklı hareketi sade bir çerçeveye koyar.

## Walras'ın daha büyük hamlesi

Marshall çoğu zaman tek bir piyasaya bakmayı kolaylaştırdı: buğday piyasası, işgücü piyasası, konut piyasası gibi. Walras ise daha cesur bir soru sordu: Bütün piyasalar birbirine bağlıysa ne olur?[^2]

Bu soru önemlidir, çünkü gerçek hayatta ekmek fiyatı yalnızca ekmekle ilgili değildir. Buğday, kira, ücret, taşıma, faiz, döviz ve tüketici geliri de işin içine girer. Bir yerdeki değişim başka yerleri iter.

Walras'ın genel denge fikrini şöyle hayal edebiliriz:

```text
emek piyasası ─┬─> gelir ─┬─> tüketim malları talebi
sermaye piyasası ───────┘
tarım ve sanayi maliyetleri ─> arz
para ve kredi koşulları ─────> fiyatlar
```

Bu model dünyayı büyük bir bağlantılar ağı gibi düşünür. Gücü buradadır. Zayıflığı da burada başlar: Dünya ne kadar karmaşıksa, modelin sade varsayımları o kadar dikkat ister.

## Marjinal verimlilik

Marjinalizm yalnızca tüketimi değil, üretimi de yeniden kurdu. Bir işletme "bir işçi daha alırsam üretim ne kadar artar?" diye sorabilir. Ya da "bir makine daha eklersem toplam çıktı ne kadar yükselir?" Bu da marjinal düşünmedir.

Temsili örnek:

| İşçi sayısı | Toplam üretim | Son işçinin ek üretimi |
|---:|---:|---:|
| 1 | 10 | 10 |
| 2 | 24 | 14 |
| 3 | 36 | 12 |
...
Başta işçiler birbirini tamamladığı için ek üretim artabilir. Sonra alan, makine veya organizasyon sınırına çarpıldığı için ek üretim düşebilir. Bu fikir ücret, kâr, rant ve üretim kararlarını açıklamak için kullanılmaya başladı.
...
Ama eksilttiği bir şey de vardır. Üretim ilişkileri, sınıf çatışması, tarihsel kurumlar ve politik güç bazen modelin arka planına itilir. İnsan "tüketici" olarak çok görünür hale gelirken, "işçi", "borçlu", "köylü" veya "sömürge öznesi" olarak daha az görünür olabilir.
